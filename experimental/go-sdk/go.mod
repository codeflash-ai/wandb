module github.com/wandb/wandb/experimental/go-sdk

go 1.24.5

require (
	github.com/wandb/wandb/core v0.0.0-20250729185623-a4a5afae2b2a
...
require (
	...
	github.com/wandb/simplejsonext v0.0.0-20241203202201-90635f1d8677 // indirect
